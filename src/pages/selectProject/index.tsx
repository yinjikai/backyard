  ...
  return <View className='form-wrap'>
    <Form onSubmit={handleSubmit}  >
      <View className='picker-wrap'>
        <Picker mode='selector' onChange={onProjectSelect} value={project} range={projects} name='project'>
          <View className='picker'>
            项目：{project}
          </View>
        </Picker>
        <Picker mode='selector' onChange={onTechnicianSelect} value={technician} range={technicians} name='technician'>
          <View className='picker'>
            技师：{technician}
          </View>
        </Picker>
